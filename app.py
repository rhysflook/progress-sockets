...
class Connection:
    ...
    def get_friends(self): 
        ...
        friend_data = requests.get(f'https://dragon-king-games.herokuapp.com/main-menu.php/draughts/backend/friends/getFriends.php?id={self.id}').json()
        friends = {}
    ...
    def get_friends_sockets(self):
        friend_data = requests.get(f'http://localhost/draughts/backend/friends/getFriends.php?id={self.id}').json()
